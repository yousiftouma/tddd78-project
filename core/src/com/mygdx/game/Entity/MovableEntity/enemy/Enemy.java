 ...
 */
public class Enemy extends MovableEntity implements Collidable
{

    public Enemy(final Sprite sprite, final Vector2 position, final Vector2 velocity, final Vector2 acceleration)
    {
